...
#define HITAG1_CONFIG_BLOCK_NUMBER  1               // config block
#define HITAG1_USER_DATA_BLOCK      4               // 1st user data block
...
#define HITAG2_CONFIG_BLOCK_NUMBER  3               // hitag2 config block
#define HITAG2_USER_DATA_BLOCK      4               // 1st user data block
...
#define HITAG2_CRYPTO_CONFIG_BLOCK  "06AA4854"      // hitag2 native, crypto mode
