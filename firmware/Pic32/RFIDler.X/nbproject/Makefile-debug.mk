...
SOURCEFILES_QUOTED_IF_SPACED="/microchip_solutions_v2013-06-15/Microchip/MDD File System/SD-SPI.c" "/microchip_solutions_v2013-06-15/Microchip/MDD File System/FSIO.c" "/microchip_solutions_v2013-06-15/Microchip/Smart Card/SClib.c" "/microchip_solutions_v2013-06-15/Microchip/Smart Card/SCpic32.c" /microchip_solutions_v2013-06-15/Microchip/USB/usb_device.c "/microchip_solutions_v2013-06-15/Microchip/USB/CDC Device Driver/usb_function_cdc.c" src/indala.c src/main.c src/psk.c src/usb_descriptors.c src/util.c src/emulate.c src/ask.c src/fsk.c src/clock.c src/rwd.c src/detect.c src/hitagcrypto.c src/wiegand.c src/comms.c src/nvm.c src/mcp414x.c src/spi.c src/uart3.c src/tags.c src/unique.c src/led.c src/em.c src/hid.c src/read.c src/isr.c src/auto.c src/fdxb.c src/hitag.c src/uid.c src/login.c src/write.c src/auth.c src/q5.c src/vtag.c src/config.c src/select.c src/sdcard.c src/debug_pins.c src/awid.c src/analogue.c src/iso7816.c src/t55x7.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/71113213/SD-SPI.o ${OBJECTDIR}/_ext/71113213/FSIO.o ${OBJECTDIR}/_ext/2096855388/SClib.o ${OBJECTDIR}/_ext/2096855388/SCpic32.o ${OBJECTDIR}/_ext/870548313/usb_device.o ${OBJECTDIR}/_ext/1379786196/usb_function_cdc.o ${OBJECTDIR}/src/indala.o ${OBJECTDIR}/src/main.o ${OBJECTDIR}/src/psk.o ${OBJECTDIR}/src/usb_descriptors.o ${OBJECTDIR}/src/util.o ${OBJECTDIR}/src/emulate.o ${OBJECTDIR}/src/ask.o ${OBJECTDIR}/src/fsk.o ${OBJECTDIR}/src/clock.o ${OBJECTDIR}/src/rwd.o ${OBJECTDIR}/src/detect.o ${OBJECTDIR}/src/hitagcrypto.o ${OBJECTDIR}/src/wiegand.o ${OBJECTDIR}/src/comms.o ${OBJECTDIR}/src/nvm.o ${OBJECTDIR}/src/mcp414x.o ${OBJECTDIR}/src/spi.o ${OBJECTDIR}/src/uart3.o ${OBJECTDIR}/src/tags.o ${OBJECTDIR}/src/unique.o ${OBJECTDIR}/src/led.o ${OBJECTDIR}/src/em.o ${OBJECTDIR}/src/hid.o ${OBJECTDIR}/src/read.o ${OBJECTDIR}/src/isr.o ${OBJECTDIR}/src/auto.o ${OBJECTDIR}/src/fdxb.o ${OBJECTDIR}/src/hitag.o ${OBJECTDIR}/src/uid.o ${OBJECTDIR}/src/login.o ${OBJECTDIR}/src/write.o ${OBJECTDIR}/src/auth.o ${OBJECTDIR}/src/q5.o ${OBJECTDIR}/src/vtag.o ${OBJECTDIR}/src/config.o ${OBJECTDIR}/src/select.o ${OBJECTDIR}/src/sdcard.o ${OBJECTDIR}/src/debug_pins.o ${OBJECTDIR}/src/awid.o ${OBJECTDIR}/src/analogue.o ${OBJECTDIR}/src/iso7816.o ${OBJECTDIR}/src/t55x7.o
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/RFIDler.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  /opt/microchip/xc32/v1.33/pic32mx/lib/libmchp_peripheral_32MX795F512L.a  
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/RFIDler.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    /opt/microchip/xc32/v1.33/pic32mx/lib/libmchp_peripheral_32MX795F512L.a       -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,--gc-sections,-Map="${DISTDIR}/${IMAGE_TYPE}.map"
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/RFIDler.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk  /opt/microchip/xc32/v1.33/pic32mx/lib/libmchp_peripheral_32MX795F512L.a 
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/RFIDler.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}    /opt/microchip/xc32/v1.33/pic32mx/lib/libmchp_peripheral_32MX795F512L.a      -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--gc-sections,-Map="${DISTDIR}/${IMAGE_TYPE}.map"
